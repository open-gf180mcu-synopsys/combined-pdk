...
# <create_cell_libs> <load_ant_clf_for_existing_lib.tcl>  
# Version: R-2020.09 (Sep 2020)
# Copyright (C) 2010-2020 Synopsys, Inc. All rights reserved.
##########################################################################

echo "\n### BEGIN_COMMAND from load_ant_clf_for_existing_lib.tcl" >> ${create_ndm_commands}

echo "\n${flow_info_prefix} Running script \"load_ant_clf_for_existing_lib.tcl\"\n"
...
echo "### END_COMMAND from load_ant_clf_for_existing_lib.tcl" >> ${create_ndm_commands}
