...
; 8/4/2025 Rhett Davis
; Adding Pwell and Nwell layers to enable import of open std. cell libraries.
; Using 240 for Pwell layerNumber, since that is the substrate layer. 
...
Layer           "Metal5" {
     ...
     fatWireThreshold	     = 10
     fatThinMinSpacing	     = 0.5
     fatFatMinSpacing	     = 0.5
     fatContactThreshold     = 3
     unitMinResistance       = 6e-5
     unitNomResistance       = 6e-5
     unitMaxResistance       = 6e-5
     unitMinCapacitance	     = 9.3e-06
     unitNomCapacitance	     = 9.3e-06
     unitMaxCapacitance	     = 9.3e-06
     unitMinSideWallCap	     = 5.3e-06
     unitNomSideWallCap	     = 5.3e-06
     unitMaxSideWallCap	     = 5.3e-06
     unitMinChannelCap	     = 9.3e-06
     unitNomChannelCap	     = 9.3e-06
     unitMaxChannelCap	     = 9.3e-06
     unitMinChannelSideCap   = 5.3e-06
     unitNomChannelSideCap   = 5.3e-06
     unitMaxChannelSideCap   = 5.3e-06
     unitMinThickness	     = 1.19
     unitNomThickness	     = 1.19
     unitMaxThickness	     = 1.19
