...
Layer           "Metal4" {
     ...
     pitch                   = 0.740
     defaultWidth            = 0.360  /* MT.1  */
     minWidth                = 0.360  /* MT.1  */
     minSpacing              = 0.380  /* MT.2a */
     ...
     unitMinResistance       = 4.8e-05
     unitNomResistance       = 6.0e-05
     unitMaxResistance       = 7.2e-05
     unitMinThickness        = 0.69
     unitNomThickness        = 0.69
     unitMaxThickness        = 0.69
