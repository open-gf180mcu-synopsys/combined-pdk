...
define_antenna_layer_rule $lib -mode 4 -layer "VIA34" -ratio 9999 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 4 -layer "MET4" -ratio 400 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 4 -layer "VIA45" -ratio 9999 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 4 -layer "MET5" -ratio 400 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 4 -layer "VIA56" -ratio 9999 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 4 -layer "MET6" -ratio 400 -diode_ratio {0 0 2 0}
...
define_antenna_layer_rule $lib -mode 1 -layer "VIA12" -ratio 20 -diode_ratio {0 0 2 0}
...
define_antenna_layer_rule $lib -mode 1 -layer "VIA34" -ratio 20 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 1 -layer "MET4" -ratio 9999 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 1 -layer "VIA45" -ratio 20 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 1 -layer "MET5" -ratio 9999 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 1 -layer "VIA56" -ratio 20 -diode_ratio {0 0 2 0}
define_antenna_layer_rule $lib -mode 1 -layer "MET6" -ratio 9999 -diode_ratio {0 0 2 0}
